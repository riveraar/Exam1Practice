...
def run_test_problem1b():
    ...
    print('Test 1 results - expected: ', expected)
    print('                 actual:   ', actual)

    expected = 1
    actual = problem1b(2, 1)
    print('Test 2 results - expected: ', expected)
    print('                 actual:   ', actual)

    expected = 44
    actual = problem1b(5, 40)
    print('Test 3 results - expected: ', expected)
    print('                 actual:   ', actual)

    expected = 21
    actual = problem1b(9, 10)
    print('Test 4 results - expected: ', expected)
    print('                 actual:   ', actual)
